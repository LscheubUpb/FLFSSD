'Entries: 6/50 (Not Modified Often)'
    ...
    with open(input_file, 'r') as file:
        for line in file:
            ...
            if match:
                ...
                x_groups.setdefault(x_value, []).append(line)
...
input_file = "C:/Users/leosc/Documents/_wichtigeDokumente/Bachelorarbeit/img.list"   # Replace with your input file path
